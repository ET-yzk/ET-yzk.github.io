import{_ as a}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as n,f as e}from"./app-cmlm9_eF.js";const p={},l=e(`<h1 id="微信小程序后端开发踩坑之django" tabindex="-1"><a class="header-anchor" href="#微信小程序后端开发踩坑之django" aria-hidden="true">#</a> 微信小程序后端开发踩坑之Django</h1><h3 id="_1-virtualenv虚拟环境的创建、激活、及退出" tabindex="-1"><a class="header-anchor" href="#_1-virtualenv虚拟环境的创建、激活、及退出" aria-hidden="true">#</a> 1. Virtualenv虚拟环境的创建、激活、及退出</h3><blockquote><p>virtualenv用于创建独立的Python环境，多个Python相互独立，互不影响。</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#  1.安装</span>
