import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as a,c as s,f as t}from"./app-cmlm9_eF.js";const e={},o=t(`<h1 id="ubuntu" tabindex="-1"><a class="header-anchor" href="#ubuntu" aria-hidden="true">#</a> Ubuntu</h1><h2 id="ubuntu-crontab-自动任务配置" tabindex="-1"><a class="header-anchor" href="#ubuntu-crontab-自动任务配置" aria-hidden="true">#</a> Ubuntu crontab 自动任务配置</h2><blockquote><p>对于可能涉及的脚本文件、代码源文件，其中所有需要用到的文件路径请使用 <strong>绝对路径</strong> ！！！</p></blockquote><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 对当前用户设定crontab执行文件，格式: [* * * * * command]</span>
